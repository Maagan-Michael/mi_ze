...
def process_image_faces(imageData, neural_net_model):
    ...
    for i, box in enumerate(boxes):
        ...
        faceData = FaceDataModel(faceId= f"{imageData.get_image_id()}_face_{i}", faceImagePath= face_image_path, personId= None, box= box)
